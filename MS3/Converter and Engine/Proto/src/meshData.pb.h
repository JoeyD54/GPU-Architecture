...
class meshData_proto final :
 ...
 public:
  ...
  enum : int {
    ...
    kVboUvFieldNumber = 8,
    kVboColorFieldNumber = 9,
    kVboIndexFieldNumber = 10,
    kTextColorFieldNumber = 11,
    kVboWeightsFieldNumber = 12,
    kVboJointsFieldNumber = 13,
    kVboInvBindFieldNumber = 14,
    kModeFieldNumber = 3,
...
void meshData_proto::set_pversion(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
 _impl_.pversion_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* meshData_proto::release_pversion() {
  ...
  _impl_._has_bits_[0] &= ~0x00000001u;
  auto* p = _impl_.pversion_.Release();
...
inline void meshData_proto::set_allocated_pversion(std::string* pversion) {
  ...
  _impl_.pversion_.SetAllocated(pversion, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.pversion_.IsDefault()) {
    _impl_.pversion_.Set("", GetArenaForAllocation());
  }
...
inline void meshData_proto::unsafe_arena_set_allocated_vbo_color(
    ::vboData_proto* vbo_color) {
  if (GetArenaForAllocation() == nullptr) {
    delete static_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.vbo_color_);
  }
  _impl_.vbo_color_ = vbo_color;
  if (vbo_color) {
...
inline void meshData_proto::unsafe_arena_set_allocated_vbo_weights(
    ::vboData_proto* vbo_weights) {
  if (GetArenaForAllocation() == nullptr) {
    delete static_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.vbo_weights_);
  }
  _impl_.vbo_weights_ = vbo_weights;
  if (vbo_weights) {
...
inline void meshData_proto::unsafe_arena_set_allocated_vbo_joints(
    ::vboData_proto* vbo_joints) {
  if (GetArenaForAllocation() == nullptr) {
    delete static_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.vbo_joints_);
  }
  _impl_.vbo_joints_ = vbo_joints;
  if (vbo_joints) {
...
inline void meshData_proto::unsafe_arena_set_allocated_vbo_invbind(
    ::vboData_proto* vbo_invbind) {
  if (GetArenaForAllocation() == nullptr) {
    delete static_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.vbo_invbind_);
  }
  _impl_.vbo_invbind_ = vbo_invbind;
  if (vbo_invbind) {
